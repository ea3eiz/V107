...
do
                          ...
                          case $actualizar in
			                    [sS]* ) echo ""
                          sh Puertos_Nextion_ESPECIAL.sh
			                    break;;
			                    [nN]* ) echo ""
			                    break;;
esac
...
sudo sed -i "14c $memoria1" $usuario/.local/memorias
sudo sed -i "13c $memoria1" $usuario/.local/memorias               
...
sudo sed -i "15c $memoria2" $usuario/.local/memorias
sudo sed -i "13c $memoria2" $usuario/.local/memorias
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
sudo sed -i "16c $memoria3" $usuario/.local/memorias
sudo sed -i "13c $memoria3" $usuario/.local/memorias
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
