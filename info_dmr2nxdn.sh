...
rxfrecuencia=$(awk "NR==13" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini)
...
id=$(awk "NR==3" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini)
id=`expr substr $id 4 9`
id=$id

indicativo=$(awk "NR==2" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini)
indicativo=`expr substr $indicativo 10 8`
indicativo=$indicativo

address=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini`
buscar=":"
caracteres=`expr index $address $buscar`
caracteres_linea=`expr $caracteres - 1`
numero_linea_address=`expr substr $address 1 $caracteres_linea`
mode=$(awk "NR==$numero_linea_address" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini)
address=`expr substr $address 13 35`
address="  "$address

#Modificación 31-10-2020 
sudo sed -i "1c Indicativo:   $indicativo" /home/pi/.local/memoria_dmr2nxdn
sudo sed -i "2c Id:           $id" /home/pi/.local/memoria_dmr2nxdn
sudo sed -i "3c RXFrecuencia: $rxfrecuencia" /home/pi/.local/memoria_dmr2nxdn
sudo sed -i "4c TXFrecuencia: $txfrecuencia" /home/pi/.local/memoria_dmr2nxdn
sudo sed -i "5c Puerto:     $puerto" /home/pi/.local/memoria_dmr2nxdn
sudo sed -i "6c Address:    $address" /home/pi/.local/memoria_dmr2nxdn
Startup=$(awk "NR==61" /home/pi/NXDNClients/NXDNGateway/NXDNGateway.ini)
Startup=`expr substr $Startup 9 20`
sudo sed -i "7c Sala NXDN:    $Startup" /home/pi/.local/memoria_dmr2nxdn               

/home/pi/V106/./qt_info_dmr2nxdn
