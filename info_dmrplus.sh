...
#sudo sed -i "1c Indicativo:   $indicativo" /home/pi/.local/memoria_dmrplus
#sudo sed -i "2c Id:           $id" /home/pi/.local/memoria_dmrplus
#sudo sed -i "3c RXFrecuencia: $rxfrecuencia" /home/pi/.local/memoria_dmrplus
#sudo sed -i "4c TXFrecuencia: $txfrecuencia" /home/pi/.local/memoria_dmrplus
#sudo sed -i "5c Puerto:     $puerto" /home/pi/.local/memoria_dmrplus
