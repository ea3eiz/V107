...
echo "   Jonathan Naylor G4KLX,David Palm PA7LIM,José Uribe CA6JAU,ON7LDS,Jimmy Roller N4IR"
echo "   Torsten DG1HT,Estefan DG8FAC,Manuel EA7EE, Juan Carlos EA7IYR y Kurt Moraw DJ0ABR." 
echo ""
